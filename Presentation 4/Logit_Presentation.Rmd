...
P($Y_i = 1$ | X) = $\frac{1}{1+e^{-(0.50913 + 0.01541(Vegas.H.R) + 0.02320(Halftime.H.R))}}$
...
P($Y_i = 1$ | Vegas.H.R = 7 & Halftime.H.R = 3) = $\frac{1}{1+e^{-(0.50913 + 0.01541(7) + 0.02320(3))}}$ = 0.6652103

This means the log odds of the home team winning, when Vegas.H.R = 7 and Halftime.H.R = 3, is 0.665
...
- $\beta_0$: When the home team is not favored to win at all (Vegas.H.R = 0) and they are not leading at halftime, the log odds of them winning is 0.509

The p-value for this beta is not significant, which means we cannot reject the null hypothesis that it is 0. 

- $\beta_1$: For every one unit increase in Vega.H.R , holding constant Halftime.H.R ,the log odds of the home team winning increases by 0.015
- $\beta_2$: For every one unit increase in Halftime.H.R , holding constant Vegas.H.R , log odds of the home team winning increases by 0.023 
...
The test statistic has a p-value of 0.0011 which is statistically significant at the alpha = 0.05 level. This suggests we can reject the null hypothesis that the beta for Vegas.H.R should be 0
